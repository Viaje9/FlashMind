...
describe('StudyService', () => {
  ...
  describe('getStudyCards', () => {
    ...
    it('牌組不存在時應該拋出 NotFoundException', async () => {
      ...
      await expect(
        service.getStudyCards('nonexistent', mockUserId, mockTimezone),
    ...
    it('使用者無權限時應該拋出 ForbiddenException', async () => {
      ...
      await expect(
        service.getStudyCards(mockDeckId, 'other-user', mockTimezone),
  ...
  describe('getSummary', () => {
    ...
    it('牌組不存在時應該拋出 NotFoundException', async () => {
      ...
      await expect(
        service.getSummary('nonexistent', mockUserId, mockTimezone),
      ).rejects.toThrow(NotFoundException);
    });
    ...
    it('使用者無權限時應該拋出 ForbiddenException', async () => {
      ...
      await expect(
        service.getSummary(mockDeckId, 'other-user', mockTimezone),
      ).rejects.toThrow(ForbiddenException);
    });
